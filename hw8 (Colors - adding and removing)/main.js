...
function initEvenHandles() {
  ...
  htmlElements.input.addEventListener("blur", inputColorBlur);
}
...
function addButtonClicked() {
  ...
  if (checkIfColorCanBeAdded(htmlElements.input.value) == false) {
    htmlElements.input.style.borderColor = "red";
    htmlElements.input.placeholder = "There's no such a color";
